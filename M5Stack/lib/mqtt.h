...
void emptyMQTTStatusMessage ()
{
}

struct MQTTStatusMessages mQTTStatusMessages = {
	emptyMQTTStatusMessage,
	emptyMQTTStatusMessage,
	emptyMQTTStatusMessage,
	emptyMQTTStatusMessage,
	emptyMQTTStatusMessage
...
void callback(char* topic, byte* payload, unsigned int length)
{
	...
	mQTTStatusMessages.display_mqtt_message_received();
...
{
	mQTTStatusMessages.display_mqtt_connect_failed();
...
void mqtt_connected()
{
	...
	mQTTStatusMessages.display_mqtt_connected_ok();
...
{
	mQTTStatusMessages.display_mqtt_connecting();
...
void loop_mqtt()
{
	...
	case ConnectedToMQTTServer:
		...
		{
			mQTTStatusMessages.display_mqtt_failed_in_use();
